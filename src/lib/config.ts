...
export const experiences: Experience[] = [
  {
    id: 3,
    title: "EDEN - Full Stack Developer & AI native Engineer",
    ...
    projects: [
      {
        ...
        title: "Project #1",
        participation:
          "Prompt Engineering, API's integration, Deployments, Databases, Marketing, workflow automation, Design, etc.",
        technologies:
          "React, TypeScript, Next.JS, Cypress, Material-UI, AWS, Vercel, Python, FastAPI, LangChain, LLMs, Claude Code, RAG, n8n, Figma",
      },
    ],
  },
  {
